...
export default function MapPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F5ECDE] flex flex-col">
      {/* Navbar — z-50 stays above the map */}
      <Navbar />

      <div className="flex-1 px-4 md:px-6 pt-4 pb-6 flex flex-col gap-3">
        ...
        <div className="flex items-center gap-3">
          <div className="relative flex-1 max-w-sm">
            ...
            <input
              ...
              className="w-full pl-9 pr-4 py-2 rounded-xl bg-white border border-gray-200 shadow-sm text-sm text-slate-800 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-[#E8594F] focus:border-transparent"
            />
          </div>
        ...
        {/* Map card — floating panel */}
        <div
          className="relative z-10 rounded-2xl overflow-hidden shadow-lg border border-gray-200 bg-white flex"
        ...
        >
          ...
          <div className="relative flex-1 overflow-hidden">
            ...
            {!selected && (
              <div className="absolute bottom-4 left-1/2 -translate-x-1/2 z-[1000] bg-white/90 backdrop-blur-sm rounded-full px-4 py-2 text-xs text-gray-500 shadow border border-gray-200 pointer-events-none whitespace-nowrap">
                {t('click_pin_hint')}
              </div>
            )}
        ...
        {/* Bottom sheet — mobile (separate rounded card below the map) */}
