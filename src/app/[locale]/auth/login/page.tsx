...
export default function LoginPage() {
  ...
  return (
    <AuthCard>
      <h1 className="text-2xl font-bold text-slate-800 text-center mb-6">{t('login_title')}</h1>

      {/* Social login */}
      <div className="flex flex-col gap-3">
        <button
          type="button"
          className="flex items-center justify-center gap-3 w-full border border-slate-200/80 rounded-xl py-3 text-sm font-semibold text-slate-700 hover:bg-white/90 active:bg-slate-100 transition-colors bg-white/50"
        >
      ...
      {/* Demo hint */}
      <div className="mb-4 px-4 py-2.5 rounded-xl bg-emerald-50/80 border border-emerald-200/80 text-emerald-700 text-sm text-center font-medium">
        {t('demo_hint')}
      </div>
